...
import { verifyWalletTopup } from "@/lib/actions/payments";
import { Button } from "@/components/ui/button";

export function TopupVerifyButtons({ topupId }: { topupId: string }) {
  ...
  function run(approve: boolean) {
    ...
    startTransition(async () => {
      const result = await verifyWalletTopup(topupId, approve, approve ? null : note);
